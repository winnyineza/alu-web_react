  ...
  (n.n = (t) => {
    ...
    (() => {
      ...
      var t = n(755),
        ...
        r = n(486),
        i = n.n(r);
      e()("<p>Holberton Dashboard</p>").appendTo("body"),
        e()("<p>Dashboard data for the students</p>").appendTo("body"),
        e()("<button>Click here to get started</button>").appendTo("body"),
        e()("<p id='count'></p>").appendTo("body"),
        e()("<p>Copyright - Holberton School</p>").appendTo("body"),
        e()("button").on(
          "click",
          i().debounce(function () {
            (o += 1), e()("#count").html(`${o} clicks on the button`);
          })
        );
      let o = 0;
    })();
